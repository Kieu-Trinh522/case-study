...
<body>
    <div class="player paused">
        <div class="album">
          <div class="cover">
            <div><img src="{{ url('storage/' . $playlists->image) }}" alt="3rdburglar by Wordburglar" /></div>
          </div>
        </div>
        ...
        <audio prelaod src="{{ asset('storage/audio/' . $playlists->audio) }}">
