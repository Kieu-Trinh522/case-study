...
<head>
    ...
    <!--Start Style -->
    <link rel="stylesheet" type="text/css" href="{{asset('fontend/Miraculous-Online-Music-Store-Template/css/fonts.css')}}">
    <link rel="stylesheet" type="text/css" href="{{asset('fontend/Miraculous-Online-Music-Store-Template/css/bootstrap.css')}}">
    <link rel="stylesheet" type="text/css" href="{{asset('fontend/Miraculous-Online-Music-Store-Template/css/font-awesome.min.css')}}">
    <link rel="stylesheet" type="text/css" href="{{asset('fontend/Miraculous-Online-Music-Store-Template/js/plugins/swiper/css/swiper.min.css')}}">
    <link rel="stylesheet" type="text/css" href="{{asset('fontend/Miraculous-Online-Music-Store-Template/js/plugins/nice_select/nice-select.css')}}">
    <link rel="stylesheet" type="text/css" href="{{asset('fontend/Miraculous-Online-Music-Store-Template/js/plugins/player/volume.css')}}">
    <link rel="stylesheet" type="text/css" href="{{asset('fontend/Miraculous-Online-Music-Store-Template/js/plugins/scroll/jquery.mCustomScrollbar.css')}}">
    <link rel="stylesheet" type="text/css" href="{{asset('fontend/Miraculous-Online-Music-Store-Template/css/style.css')}}">
    <!-- Favicon Link -->
    <link rel="shortcut icon" type="image/png" href="{{asset('fontend/Miraculous-Online-Music-Store-Template/images/favicon.png')}}">
</head>
...
<div class="ms_loader">
    <div class="wrap">
        <img src="{{asset('fontend/Miraculous-Online-Music-Store-Template/images/loader.gif')}}" alt="">
    </div>
</div>
<!----Main Wrapper Start---->
<div class="ms_main_wrapper">
    ...
    <div class="ms_sidemenu_wrapper">
        ...
        <div class="ms_sidemenu_inner">
            <div class="ms_logo_inner">
                <div class="ms_logo">
                    <a href="{{asset('fontend/Miraculous-Online-Music-Store-Template/index-2.html')}}"><img src="{{asset('fontend/Miraculous-Online-Music-Store-Template/')}}images/logo.png" alt="" class="img-fluid"/></a>
                </div>
                <div class="ms_logo_open">
                    <a href="{{asset('fontend/Miraculous-Online-Music-Store-Template/index-2.html')}}"><img src="{{asset('fontend/Miraculous-Online-Music-Store-Template/images/open_logo.png')}}" alt="" class="img-fluid"/></a>
                </div>
            </div>
            <div class="ms_nav_wrapper">
                <ul>
                    <li><a href="{{asset('fontend/Miraculous-Online-Music-Store-Template/index-2.html')}}" class="active" title="Discover">
						<span class="nav_icon">
                    ...
                    <li><a href="{{asset('fontend/Miraculous-Online-Music-Store-Template/album.html')}}" title="Albums">
						<span class="nav_icon">
                    ...
                    <li><a href="{{asset('fontend/Miraculous-Online-Music-Store-Template/artist.html')}}" title="Artists">
						<span class="nav_icon">
                    ...
                    <li><a href="{{asset('fontend/Miraculous-Online-Music-Store-Template/genres.html')}}" title="Genres">
						<span class="nav_icon">
                    ...
                    <li><a href="{{asset('fontend/Miraculous-Online-Music-Store-Template/top_track.html')}}" title="Top Tracks">
						<span class="nav_icon">
                    ...
                    <li><a href="{{asset('fontend/Miraculous-Online-Music-Store-Template/free_music.html')}}" title="Free Music">
						<span class="nav_icon">
                    ...
                    <li><a href="{{asset('fontend/Miraculous-Online-Music-Store-Template/stations.html')}}" title="Stations">
						<span class="nav_icon">
                ...
                <ul class="nav_downloads">
                    <li><a href="{{asset('fontend/Miraculous-Online-Music-Store-Template/download.html')}}" title="Downloads">
						<span class="nav_icon">
                    ...
                    <li><a href="{{asset('fontend/Miraculous-Online-Music-Store-Template/purchase.html')}}" title="Purchased">
						<span class="nav_icon">
                    ...
                    <li><a href="{{asset('fontend/Miraculous-Online-Music-Store-Template/favourite.html')}}" title="Favourites">
						<span class="nav_icon">
                    ...
                    <li><a href="{{asset('fontend/Miraculous-Online-Music-Store-Template/history.html')}}" title="History">
						<span class="nav_icon">
                ...
                <ul class="nav_playlist">
                    <li><a href="{{asset('fontend/Miraculous-Online-Music-Store-Template/feature_playlist.html')}}" title="Featured Playlist">
						<span class="nav_icon">
                    ...
                    <li><a href="{{asset('fontend/Miraculous-Online-Music-Store-Template/add_playlist.html')}}" title="Create Playlist">
						<span class="nav_icon">
        ...
        <div class="ms_header">
            <div class="ms_top_left">
                <div class="ms_top_search">
                    ...
                    <span class="search_icon">
							<img src="{{asset('fontend/Miraculous-Online-Music-Store-Template/images/svg/search.svg')}}" alt="">
						</span>
                </div>
            ...
            <div class="ms_top_right">
                <div class="ms_top_lang">
                    <span data-toggle="modal" data-target="#lang_modal">languages <img src="{{asset('fontend/Miraculous-Online-Music-Store-Template/images/svg/lang.svg')}}" alt=""></span>
                </div>
                ...
                <div class="row">
                    <div class="col-lg-12 col-md-12">
                        <div class="ms_banner_img">
                            <img src="{{asset('fontend/Miraculous-Online-Music-Store-Template/images/banner.png')}}" alt="" class="img-fluid">
                        </div>
                        ...
                        <div class="swiper-slide">
                            ...
                            <div class="ms_rcnt_box">
                                ...
                                <div class="ms_rcnt_box_img">
                                    <img {{asset($playlist->image)}} alt="">
                                    <div class="ms_main_overlay">
                                        <div class="ms_box_overlay"></div>
                                        <div class="ms_more_icon">
                                            <img src="{{asset('fontend/Miraculous-Online-Music-Store-Template/images/svg/more.svg')}}" alt="">
                                        </div>
                                        ...
                                        <div class="ms_play_icon">
                                            <img src="{{asset('fontend/Miraculous-Online-Music-Store-Template/images/svg/play.svg')}}" alt="">
                                        </div>
                                    </div>
                                </div>
                                <div class="ms_rcnt_box_text">
                                    <h3><a href="#">{{asset($playlist->	music_name)}}</a></h3>
                                    <p>{{asset($playlist->singer)}}</p>
                                </div>
                                ...
                                <div class="weekly_left">
                                    ...
                                    <div class="w_top_song">
                                        <div class="w_tp_song_img">
                                            <img src="{{asset($playlist->image)}}" alt="" class="img-fluid">
    ...
    <div class="ms_footer_wrapper">
        <div class="ms_footer_logo">
            <a href="{{asset('fontend/Miraculous-Online-Music-Store-Template/index-2.html')}}"><img src="images/open_logo.png" alt=""></a>
        </div>
                    ...
                    <div class="jp_queue_wrapper">
                        ...
                        <div id="playlist-wrap" class="jp-playlist">
                            ...
                            <div class="jp_queue_btn">
                                ...
                                <a href="{{asset('fontend/Miraculous-Online-Music-Store-Template/clear_modal.html')}}" class="ms_save" data-toggle="modal"
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="ms_register_form">
                        ...
                        <a href="{{asset('fontend/Miraculous-Online-Music-Store-Template/profile.html')}}" class="ms_btn" target="_blank">login now</a>
...
<!--Main js file Style-->
<script type="text/javascript" src="{{asset('fontend/Miraculous-Online-Music-Store-Template/js/jquery.js')}}"></script>
<script type="text/javascript" src="{{asset('fontend/Miraculous-Online-Music-Store-Template/js/bootstrap.min.js')}}"></script>
<script type="text/javascript" src="{{asset('fontend/Miraculous-Online-Music-Store-Template/js/plugins/swiper/js/swiper.min.js')}}"></script>
<script type="text/javascript" src="{{asset('fontend/Miraculous-Online-Music-Store-Template/js/plugins/player/jplayer.playlist.min.js')}}"></script>
<script type="text/javascript" src="{{asset('fontend/Miraculous-Online-Music-Store-Template/js/plugins/player/jquery.jplayer.min.js')}}"></script>
<script type="text/javascript" src="{{asset('fontend/Miraculous-Online-Music-Store-Template/js/plugins/player/audio-player.js')}}"></script>
<script type="text/javascript" src="{{asset('fontend/Miraculous-Online-Music-Store-Template/js/plugins/player/volume.js')}}"></script>
<script type="text/javascript" src="{{asset('fontend/Miraculous-Online-Music-Store-Template/js/plugins/nice_select/jquery.nice-select.min.js')}}"></script>
<script type="text/javascript" src="{{asset('fontend/Miraculous-Online-Music-Store-Template/js/plugins/scroll/jquery.mCustomScrollbar.js')}}"></script>
<script type="text/javascript" src="{{asset('fontend/Miraculous-Online-Music-Store-Template/js/custom.js')}}"></script>
</body>
